...
- Tras extraer Recuerdos, Notificaciones, Push, Sync, Auth y la primera capa de Planes, `script.js` queda en torno a 131 KB.
...
- `app/js/plans.js` contiene el catálogo de servicios y centraliza listar/crear/actualizar/borrar/vaciar `propuestas`; `script.js` ya no accede directamente a esa tabla.
